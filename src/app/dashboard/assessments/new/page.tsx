...
export default function NewAssessmentPage() {
  ...
  // Step tracking: 1=Details, 2=Topic, 3=Questions, 4=Answers, 5=Saved
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            {["Details", "Topic", "Questions", "Answers", "Saved"].map(
              (label, i) => (
                <div key={label} className="flex items-center">
                  ...
                  {i < 4 && (
                    <div className="mx-4 h-px w-8 bg-gray-300 sm:w-16" />
                  )}
                </div>
              )
            )}
        ...
        {step === 2 && (
          <div className="rounded-lg bg-white p-8 shadow-sm">
            <h2 className="mb-6 text-xl font-bold text-gray-900">
              What topic do you want to build questions on?
            </h2>
            <div className="space-y-5">
              <div>
                <label
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Be specific for better questions. Include subtopics, difficulty
                  preferences, or any context.
                </p>
              </div>
              <div className="flex gap-3 pt-4">
                <button
                  onClick={() => setStep(1)}
                  className="rounded-md bg-gray-100 px-6 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-200"
                >
                  Back
                </button>
                <button
            ...
            {generating && (
              <div className="mt-6 flex items-center gap-3 rounded-md bg-blue-50 p-4">
                ...
                <p className="text-sm text-blue-700">
                  AI is generating {totalQuestions} questions on &ldquo;{topic}&rdquo;...
                </p>
              </div>
            )}
          </div>
        ...
        {/* Step 3: Review Questions & Set Types */}
        {step === 3 && (
          <div className="space-y-4">
            <div className="rounded-lg bg-white p-6 shadow-sm">
              <h2 className="mb-2 text-xl font-bold text-gray-900">
                Review & Configure Questions
              </h2>
              <p className="text-sm text-gray-500">
                Review the generated questions and choose the answer type for
                each one.
              </p>
            </div>
            ...
            {generating && (
              <div className="flex items-center gap-3 rounded-md bg-blue-50 p-4">
                <div className="h-5 w-5 animate-spin rounded-full border-2 border-blue-600 border-t-transparent" />
                <p className="text-sm text-blue-700">
                  AI is generating correct answers for each question...
                </p>
              </div>
            )}
          </div>
        ...
        {step === 4 && (
          <div className="space-y-4">
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <p className="text-sm text-gray-500">
                Review the generated answers. Click &ldquo;Save Assessment&rdquo; when
                you&apos;re satisfied.
              </p>
            </div>
        ...
        {step === 5 && (
          <div className="rounded-lg bg-white p-8 text-center shadow-sm">
            ...
            <p className="mb-6 text-sm text-gray-500">
              &ldquo;{name}&rdquo; with {questions.length} questions has been saved
              successfully.
            </p>
